...
let initialState: MoviceState = {
    pic: 'https://p0.meituan.net/movie/0355f74de087b699b85b7daa3d7881ec365712.jpg@464w_644h_1e_1c', // 图片
    video: 'http://preview.ewang.com/movie/videos/854x4800e1f7602b5a5408192f799f950125901.mp4', // 预告片地址
    name: '战狼 2', // 影片名字
    director: '吴京', // 导演
    actor: [
        {
...
export default function(state: MoviceState = initialState, action: AnyAction): MoviceState {
    switch (action.type) {
        default:
            return state;
    }
